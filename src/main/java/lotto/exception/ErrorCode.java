...
public enum ErrorCode {
    ...
    BONUS_NUMBER_NOT_A_NUMBER("보너스 번호는 숫자여야 합니다."),
    BONUS_NUMBER_RANGE_INVALID("보너스 번호는 1부터 45 사이의 숫자여야 합니다."),
    BONUS_NUMBER_DUPLICATE("보너스 번호는 당첨 번호와 중복될 수 없습니다."),
    WINNING_NUMBERS_NOT_A_NUMBER("당첨 번호는 숫자여야 합니다."),
    PURCHASE_AMOUNT_NOT_A_NUMBER("구입 금액은 숫자여야 합니다."),
    PURCHASE_AMOUNT_TOO_LOW("구입 금액은 1,000원 이상이어야 합니다."),
    PURCHASE_AMOUNT_NOT_UNIT("구입 금액은 1,000원 단위여야 합니다.");
